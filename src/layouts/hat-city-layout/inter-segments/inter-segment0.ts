import { p1 as seg0P1 } from '@layout/segments/primitives0';
import { p1 as seg4P1 } from '@layout/segments/primitives4';
import { p1 as seg5P1 } from '@layout/segments/primitives5';
import { p1 as seg6P1 } from '@layout/segments/primitives6';
